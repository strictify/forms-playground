...
class ComplexUserType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder->add('movies', CollectionType::class, [
            ...
            'add_value'    => /** @psalm-param S $data */ fn(object $data, User $user) => $this->favoriteMovieRepository->create($user, $data->getMovie(), $data->getComment()),
